...
namespace ECE141 {
  ...
  enum class Keywords {
    ...
    in_kw, index_kw, inner_kw, insert_kw, integer_kw, into_kw, join_kw, key_kw, left_kw, limit_kw,
    ...
    table_kw, tables_kw, timestamp_kw, unknown_kw, unique_kw, update_kw, use_kw,
